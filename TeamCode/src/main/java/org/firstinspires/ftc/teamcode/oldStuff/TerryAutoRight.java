...
// this is detecting the saved color of red and giving the bot commands to move to the middle
        if(SavedColor<30){
            ...
            lf.setTargetPosition((int) (2 * wheelOneInch));
            rf.setTargetPosition((int) (2 * wheelOneInch));
            lb.setTargetPosition((int) (2 * wheelOneInch));
            rb.setTargetPosition((int) (2 * wheelOneInch));
            arm.setTargetPosition(0);
        ...
        //Finds value of SavedColor, if within set hue amount, it goes to the third parking station
            ...
            rb.setTargetPosition((int) (18 * wheelOneInch));
            arm.setTargetPosition(0);
            ...
            lf.setTargetPosition((int) (-13 * wheelOneInch));
            rf.setTargetPosition((int) (-13 * wheelOneInch));
            lb.setTargetPosition((int) (-13 * wheelOneInch));
            rb.setTargetPosition((int) (-13 * wheelOneInch));
            arm.setTargetPosition(0);
        ...
        //looks for SavedColor for yellow, and checks if its in its range
            ...
            lf.setTargetPosition((int) (25 * wheelOneInch));
            rf.setTargetPosition((int) (25 * wheelOneInch));
            lb.setTargetPosition((int) (25 * wheelOneInch));
            rb.setTargetPosition((int) (25 * wheelOneInch));
            arm.setTargetPosition(0);
            ...
            lf.setTargetPosition((int) (-25 * wheelOneInch));
            rf.setTargetPosition((int) (35 * wheelOneInch));
            lb.setTargetPosition((int) (-25 * wheelOneInch));
            rb.setTargetPosition((int) (25 * wheelOneInch));
            arm.setTargetPosition(0);
