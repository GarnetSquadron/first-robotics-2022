...
public class DcMotorPrimaryOuttakePivot{
    ...
    public Action BucketPos() {
        return pivot.GoToAngleAndHoldIt(135,0,0.5, AngleUnitV2.DEGREES);
    }
    public Action SpecimenOnWallPos() {
        return pivot.GoToAngleAndHoldIt(225,0,0.5, AngleUnitV2.DEGREES);
    }
    public Action SpecimenOnChamberPos() {
        return pivot.GoToAngleAndHoldIt(0,0,0.5, AngleUnitV2.DEGREES);
    }
    public Action SpecimenOnChamberPosV2() {
        return new SequentialAction(pivot.GoToAngleAndHoldIt(0,0,0.5, AngleUnitV2.DEGREES), pivot.GoToAngleAndHoldIt(70,0,0.5,AngleUnitV2.DEGREES));
    }
    public Action prepareForSpecimenOnChamberPos() {
        return pivot.GoToAngleAndHoldIt(45,0,0.5,AngleUnitV2.DEGREES);
    }

    public Action TransferPos() {
        return pivot.GoToAngleAndHoldIt(0.03,0,0.5,AngleUnitV2.DEGREES);
    }
    public Action outOfTheWayOfIntakePos(){
        return pivot.GoToAngleAndHoldIt(0.2,0,0.5,AngleUnitV2.DEGREES);
    }
    public Action zeroMotor(){return pivot.goUntilStoppedAndAssumeTgtAngleHasBeenReached(0,0,AngleUnitV2.DEGREES);}
